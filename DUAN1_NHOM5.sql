...
'5C90200A-9DFB-4143-B766-2722625F3B0A',N'Nguyễn Văn Hải',100,N'chất liệu thoáng mát',1,800000),
...
'0553F1B1-E7D2-43B7-9E5F-614FC8DD704D',N'Nguyễn Văn Hải',200,N'sang trọng, lịch lãm',1,700000),
...
'F09F2EA1-6158-4A13-9627-DB6639598EAE',N'Nguyễn Thị Nhung',300,N'trẻ trung, năng động',1,700000)
...
('F09F2EA1-6158-4A13-9627-DB6639598EAE','KM01',N'Sale 11/11/2021',30,'11/11/2021','11/12/2021',0,500),
('5672FEA4-C628-4FE7-9746-F82D255C8616','KM02',N'Sale 12/12/2021',10,'12/12/2021','12/13/2021',0,200),
('5C90200A-9DFB-4143-B766-2722625F3B0A','KM03',N'Sale 04/04/2024',20,'04/04/2025','04/04/2023',1,100)


-- INSERT KHUYENMAICHITIET
INSERT INTO KHUYENMAICHITIET (MAKMCT,IDKM,IDSPCT,TRANGTHAIKMCT) VALUES
('KMCT01','EA14077B-70CB-448D-9DD8-2B5432EE36F2','59C249EC-5C65-4106-AD26-0A5EEEAE3883',1),
('KMCT02','4B4A3B15-78AE-465D-AD6A-4BAD40915182','3578ED65-CF6C-4382-A5C6-2C86B0771DC0',0)
...
SELECT * from HoaDon left join NHANVIEN NV on HOADON.IDNV = NV.ID WHERE TRANGTHAIHD = 0
...
update HOADONCT set SOLUONG = 1 where ID = '7C81BB68-38D3-4EA8-8C62-076798E01AAB'
...
SELECT MASPCT,TENSP,SOLUONG,SANPHAMCHITIET.DONGIA FROM HOADON INNER JOIN
				  ...
				  SANPHAM ON SANPHAMCHITIET.IDSP = SANPHAM.ID WHERE MAHD = '3038' 
...
select hd.mahdct from hoadonct hd join sanphamchitiet sp on hd.idspct = sp.id join hoadon h on h.id = hd.idhd where sp.maspct = 'SPCT02' and h.mahd = '8837'

SELECT * from HoaDon left join NHANVIEN NV on HOADON.IDNV = NV.ID WHERE TRANGTHAIHD = 1
...
delete from SANPHAM where MASP = 'SP07007'

SELECT * from HoaDon left join NHANVIEN NV on HOADON.IDNV = NV.ID WHERE TRANGTHAIHD = 1

select hd.mahdct from hoadonct hd join sanphamchitiet sp on hd.idspct = sp.id join hoadon h on h.id = hd.idhd where sp.maspct = 'SPCT03' and h.mahd = '3038'
