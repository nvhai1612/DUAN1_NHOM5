...
public class MissPassJpane extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnHoantat.setBackground(new java.awt.Color(48, 194, 254));
        btnHoantat.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnHoantat.setForeground(new java.awt.Color(255, 255, 255));
        btnHoantat.setText("Hoàn tất");
        btnHoantat.setPreferredSize(new java.awt.Dimension(280, 50));
                ...
                .addGroup(pnlQuenMatKhauLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlQuenMatKhauLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlQuenMatKhauLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnHoantat, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(pnlQuenMatKhauLayout.createSequentialGroup()
                        .addGap(121, 121, 121)
        ...
        pnlQuenMatKhauLayout.setVerticalGroup(
            ...
            .addGroup(pnlQuenMatKhauLayout.createSequentialGroup()
                ...
                .addGap(43, 43, 43)
                .addComponent(btnHoantat, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnHoantatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHoantatActionPerformed
        String passNew = txtPasswordForget.getText();
        String passConfind = txtPasswordForgetConfirm.getText();
        String email = (String) ss.get("email");
        if(passConfind.equalsIgnoreCase(passNew)){
            NhanVien nv = nhanVienRepo.selectByEmail(email);
            nv.setMatKhau(passConfind);
            nvs.update(nv);
    ...
    private void btnNhanMaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhanMaActionPerformed
        ...
        NhanVien nv = nhanVienRepo.selectByEmail(email);
        xemail.sendEmail(nv.getEmail(), "abc");
        ss.set(email, nv);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MissPassJpane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MissPassJpane().setVisible(true);
            }
        });
    }
