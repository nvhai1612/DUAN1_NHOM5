...
public SanPhamChiTiet searchbyMaSp(String ma) {
        ArrayList<SanPhamChiTiet> listCTSP = new ArrayList<>();
...
//    public String SelectSPById(UUID IdSP) {
//        
//        try (Connection con = connection.getConnection();
//                PreparedStatement ps = con.prepareStatement("SELECT TENSP FROM SANPHAM WHERE ID = ?")){
//            ps.setObject(1, IdSP);
//            ResultSet rs = ps.executeQuery();
//           
//            while (rs.next()) {                
