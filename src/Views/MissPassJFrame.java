 ...
 * @author Admin
 */
public class MissPassJFrame extends javax.swing.JFrame {

    /**
     * Creates new form MissPassJFrame
     */
    public MissPassJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MissPassJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MissPassJFrame().setVisible(true);
            }
        });
    }
